                            ...
                            <table id="viewRestSignUps">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {//PRINT THE RESTAURANT SIGNUP APPLICATIONS
                                        ...
                                        . "<td>" . $row['endTime'] . "</td>"
                                        . "<td>" . $row['cap'] . "</td>"
                                        . "<form method='post' action='Admin.php?varname=$rname'>"
                                        . "<td> <button type='submit' class='btn' name='acceptBooking'>Accept</button></a></td>"
                                        . "<td> <button type='submit' class='btn' name='declineBooking'>Decline</button></a></td>"
                                        . "</form>"
                                        . "</tr>";
                                    }
                                    ?>
